const api = {
  ...
  const saveButton = document.querySelector('button#salvad').addEventListener('click', saveWeather, false);
  ...
  function getLocation() {
    ...
    else { cityName.innerText = "Seu navegador não suporta Geolocalização."; }
  };
  ...
  function showError(error) {
    switch (error.code) {
      case error.PERMISSION_DENIED:
        cityName.innerText = "Clique em “Permitir”";
        break;
      case error.POSITION_UNAVAILABLE:
        cityName.innerText = "Geolocalização indisponível.";
        break;
      case error.TIMEOUT:
        cityName.innerText = "A petição expirou.";
        break;
      case error.UNKNOWN_ERROR:
        cityName.innerText = "Erro desconhecido. Por favor, recarregue a página";
        break;
    };
  };
